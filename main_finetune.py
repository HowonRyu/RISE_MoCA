...
def get_args_parser():
    ...
    parser.add_argument('--cleanlab_filter', action='store_true', default=False,
                        help='only do classification with the filtered labels from cleanlab')
    ...
    if args.SCV == True:
        ...
        if args.data == "RISE":
            dataset_train = RISE(data_path=args.data_path, is_test=False, normalization=args.normalization,
                                ...
                                cleanlab_filter=args.cleanlab_filter)
